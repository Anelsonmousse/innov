...
const page = () => {
  ...
  const activateShop2 = async () => {
    ...
    const endpoint = "https://api.vplaza.com.ng/shops/activateShop2";
    const requestData = {
        requestID,
    ...
    try {
        ...
        if(response.data.status === true){
          ...
          alert('An error occurred while Activating shop, Please try again shortly!')
        }
    } catch (error) {
