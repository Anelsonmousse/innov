                  ...
                  currentProducts.map((item, index) => (
                      ...
                      >
                          <img
                              ...
                              width={120}
                              height={130}
                              className="w-[120px] h-[130px] object-cover rounded-[7px]"
                          />
                          <div className="w-full">
                              <div className="mt-2 text-[12px] font-bold w-[120px] truncate overflow-hidden whitespace-nowrap">
                          ...
                          <div className="flex flex-col text-sm w-full">
                              ...
                              <div className="font-medium text-xs w-[120px] truncate overflow-hidden whitespace-nowrap">{item.shopDetails.shop_name}</div>
                          </div>
...
>
    ...
    <div className="relative flex justify-end w-full items-center mt-2">
      ...
      <div className="flex items-center cursor-pointer" onClick={() => {
          ...
          col>
        <p className="text-white pr-[5px] pt-[10px] text-[13px] mr-4">See More</p>
      </div>
    </div>
  </div>
</div>
